...
public class GetTicketsQueryHandler : IRequestHandler<GetTicketsQuery, IReadOnlyList<TicketResponseDto>>
{
    ...
    public async Task<IReadOnlyList<TicketResponseDto>> Handle(GetTicketsQuery request, CancellationToken cancellationToken)
    {
